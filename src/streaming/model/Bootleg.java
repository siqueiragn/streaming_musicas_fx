 ...
 * @author Gabriel
 */
public class Bootleg extends Colecao{

    public Bootleg(int id, String nome, List<Interprete> interpretes, List<Interprete> compositores, int lancamento) {
